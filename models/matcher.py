# This is probably the biggest bottleneck of the algorithm right now
import torch
from torch import nn
from torchvision.ops import generalized_box_iou, box_convert

# probably one of the slowest part of the entire algorithm
from scipy.optimize import linear_sum_assignment


# Does it need to be a nn.Module?
class HungarianMatcher(nn.Module):
  ...
  def forward(self, outputs_logits, outputs_boxes, targets):
    ...
    # TODO: How to avoid this extra trip to CPU???
