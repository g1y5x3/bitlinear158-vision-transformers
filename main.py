...
def get_args_parser():
    ...
    # TODO: to be compatable with BitLinear, pre-norm might need to be the default option
...
def main(args):
    ...
    run = wandb.init(project="BitNet-DETR") if utils.is_main_process() else None
